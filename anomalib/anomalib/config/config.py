...
def get_configurable_parameters(
    ...
    if config_path is None:
        config_path = Path(f"C:/Users/Charlool/Desktop/cs_studies_carmeliol/deep_learning_proj/anomalib/anomalib/models/{model_name}/{config_filename}.{config_file_extension}")
